// Problem Statement: Write a program to implement the Quick Sort algorithm to sort a linked list of integers in ascending order and find the median of the sorted list.
